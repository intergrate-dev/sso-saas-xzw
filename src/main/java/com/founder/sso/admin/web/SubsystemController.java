...
@Controller
@RequestMapping(value="/admin/subsystem")
public class SubsystemController {
	...
	public String subsystem(Model model){
		...
		return "/admin/subsystem/subsystemList";
	}
    ...
    public String initUpdate(Long id, Model model) {
    	...
    	if(!StringUtils.isEmpty(id)){
    		Subsystem subsystem = subsystemService.findOne(id);
    		model.addAttribute("subsystem", subsystem);
    	}
    	
    	return "/admin/subsystem/updateSubsystem";
    }
    /**
     * 检查code是否已经存在
    ...
    public String save(Subsystem subsystem) {
    ...
    public String delete(@PathVariable("id")Long id, RedirectAttributes attr) {
    	...
    	return "redirect:/admin/subsystem";
    }
}
