...
//验证表单是否正确
	...
	if(regtype == "phone"){
		$(".tr_email").addClass("hidden");  //隐藏邮箱文本框
	}else if(regtype == "email"){
		$(".tr_phone").addClass("hidden");  //隐藏文本框
	}
});
...
<body>
	<div class="container_s">
		...
		<div class="content" style="" >
			...
			<input id="regtype" type="hidden" value="phone" />
			...
			<table style="border: 0px;" class="table">
				<tr class="noRegister">
					...
					<td>
			     		<input type="text" id="username" name="username" value="<shiro:principal property="nickname"/>" maxlength="16" class="isUser soleUsername text soleUsernameForm" placeholder='请输入用户名' required autofocus>     
					</td>
				</tr>
				...
				<tr class="noRegister">
					...
					<td>
			     		<input type="password" id="password_re" name="password_re" class="text" rangelength="6,20" maxlength="32" placeholder='请输入密码' required>
					</td>
				</tr>
				...
				<tr class="hasRegister">
					...
					<td>
			     		<input type="password" id="password" name="password" class="text passwordInput" maxlength="32" placeholder='请输入密码' required>
					</td>
				</tr>
				<tr>
					<td style="text-align:right;width:33%"></td>
					<td>
						<input value="创建并绑定账号" type="submit" id="butt" class="btn btn-success" style="width: 140px;font-size: 1em;">
						<input value="取消绑定" type="button" id="cancelBtn" class="btn btn-success" style="width: 116px;font-size: 1em;" onclick="location.href='${ctx}/user/login'">
					</td>
				</tr>
			</table>
		</form>
